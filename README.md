...
[![Download Windows](https://img.shields.io/badge/Download-Windows-blue?style=for-the-badge&logo=windows)](https://github.com/sudoabc/apple_music_rpc/releases/latest/download/apple_music_rpc_windows.exe)
[![Download macOS](https://img.shields.io/badge/Download-macOS-white?style=for-the-badge&logo=apple)](https://github.com/sudoabc/apple_music_rpc/releases/latest/download/apple_music_rpc_macos)
...
### For macOS
1. Download the `apple_music_rpc_macos` binary from the latest release.
2. Open your terminal, navigate to the download folder, and make it executable:
   ```bash
   chmod +x apple_music_rpc_macos
   ```
3. Run the application:
   ```bash
   ./apple_music_rpc_macos
   ```

> [!IMPORTANT]
> If macOS prevents the app from opening because it's from an "unidentified developer", find the file in Finder, Right-Click it, and select Open. Alternatively, go to System Settings > Privacy & Security and click "Allow Anyway".
